 ...
 */
var Ul=Object.defineProperty;var Bc=Object.getOwnPropertyDescriptor;var a2=Object.getOwnPropertyNames;var l2=Object.prototype.hasOwnProperty;var Dl=(t,i)=>{for(var e in i)Ul(t,e,{get:i[e],enumerable:!0})},Pc=(t,i,e,r)=>{if(i&&typeof i=="object"||typeof i=="function")for(let n of a2(i))!l2.call(t,n)&&n!==e&&Ul(t,n,{get:()=>i[n],enumerable:!(r=Bc(i,n))||r.enumerable});return t},Vl=(t,i,e)=>(Pc(t,i,"default"),e&&Pc(e,i,"default"));var Nc=(t,i,e,r)=>{for(var n=r>1?void 0:r?Bc(i,e):i,s=t.length-1,a;s>=0;s--)(a=t[s])&&(n=(r?a(i,e,n):a(n))||n);return r&&n&&Ul(i,e,n),n};var wc={};Dl(wc,{ASTBuilder:()=>Ac,ArrayLiteralExpression:()=>mr,ArrowKind:()=>_i,AssertionExpression:()=>ia,AssertionKind:()=>pi,AtomicRMWOp:()=>gp,BinaryExpression:()=>na,BinaryModule:()=>cl,BinaryOp:()=>di,BlockStatement:()=>Pa,BrOnOp:()=>By,BreakStatement:()=>Ba,CallExpression:()=>sa,Class:()=>Kt,ClassDeclaration:()=>dn,ClassExpression:()=>aa,ClassPrototype:()=>Kn,CommaExpression:()=>la,CommentKind:()=>pp,CommentNode:()=>ra,CommonFlags:()=>Ve,CommonNames:()=>C,CompiledExpression:()=>wa,Compiler:()=>hs,ConditionKind:()=>Lp,ConstantValueKind:()=>Up,Constraints:()=>Sc,ConstructorExpression:()=>oa,ContinueStatement:()=>Na,DEFAULT_STACK_SIZE:()=>qI,DeclarationStatement:()=>We,DeclaredElement:()=>Ht,DecoratorFlags:()=>jt,DecoratorKind:()=>Tt,DecoratorNode:()=>ta,DiagnosticCategory:()=>Js,DiagnosticCode:()=>st,DiagnosticEmitter:()=>qe,DiagnosticMessage:()=>Qs,DoStatement:()=>La,Element:()=>Vn,ElementAccessExpression:()=>ua,ElementKind:()=>ut,EmptyStatement:()=>Ma,Enum:()=>kl,EnumDeclaration:()=>Ga,EnumValue:()=>Al,EnumValueDeclaration:()=>za,ExportDefaultStatement:()=>qa,ExportImportStatement:()=>Ua,ExportMember:()=>Da,ExportNames:()=>_s,ExportStatement:()=>Va,Expression:()=>de,ExpressionId:()=>br,ExpressionRunnerFlags:()=>_l,ExpressionStatement:()=>Oa,ExternalKind:()=>yp,FEATURES_ALL:()=>a0,FEATURES_DEFAULT:()=>l0,FEATURE_BULK_MEMORY:()=>$I,FEATURE_EXCEPTION_HANDLING:()=>YI,FEATURE_EXTENDED_CONST:()=>n0,FEATURE_GC:()=>t0,FEATURE_MEMORY64:()=>r0,FEATURE_MULTI_VALUE:()=>e0,FEATURE_MUTABLE_GLOBALS:()=>HI,FEATURE_NONTRAPPING_F2I:()=>jI,FEATURE_REFERENCE_TYPES:()=>JI,FEATURE_RELAXED_SIMD:()=>i0,FEATURE_SIGN_EXTENSION:()=>KI,FEATURE_SIMD:()=>XI,FEATURE_STRINGREF:()=>s0,FEATURE_TAIL_CALLS:()=>QI,FEATURE_THREADS:()=>ZI,FalseExpression:()=>Ra,Feature:()=>Ut,FeatureFlags:()=>mp,FieldDeclaration:()=>Wa,FieldFlags:()=>Np,File:()=>On,FloatLiteralExpression:()=>pa,Flow:()=>St,FlowFlags:()=>xl,ForOfStatement:()=>Ha,ForStatement:()=>Ka,Function:()=>ct,FunctionDeclaration:()=>mn,FunctionExpression:()=>ca,FunctionPrototype:()=>je,FunctionTypeNode:()=>dr,GETTER_PREFIX:()=>Ds,Global:()=>Tr,HeapTypeRef:()=>ue,INDEX_SUFFIX:()=>Le,INNER_DELIMITER:()=>Xu,INSTANCE_DELIMITER:()=>$u,IdentifierExpression:()=>Oe,IdentifierHandling:()=>_p,IfStatement:()=>ja,ImportDeclaration:()=>$a,ImportNames:()=>Pi,ImportStatement:()=>yn,IndexSignature:()=>Mn,IndexSignatureNode:()=>Ca,InstanceOfExpression:()=>_a,IntegerLiteralExpression:()=>fa,Interface:()=>Gn,InterfaceDeclaration:()=>Xa,InterfacePrototype:()=>wl,JSBuilder:()=>Ri,LIBRARY_PREFIX:()=>nt,LIBRARY_SUBST:()=>qs,LiteralExpression:()=>at,LiteralKind:()=>Vt,Local:()=>Ue,LocalFlags:()=>Bn,MemorySegment:()=>hi,MethodDeclaration:()=>yr,Module:()=>Ot,ModuleDeclaration:()=>rl,NamedTypeNode:()=>hr,Namespace:()=>Wn,NamespaceDeclaration:()=>Za,NewExpression:()=>ha,Node:()=>L,NodeKind:()=>xt,NullExpression:()=>da,ObjectLiteralExpression:()=>ma,OmittedExpression:()=>ya,OperatorKind:()=>Re,Options:()=>fs,PARENT_SUBST:()=>d2,PATH_DELIMITER:()=>Ye,PackedType:()=>Tn,Parameter:()=>zp,ParameterKind:()=>gr,ParameterNode:()=>oi,ParenthesizedExpression:()=>ga,Parser:()=>Un,Precedence:()=>Oy,Program:()=>Dn,Property:()=>Ln,PropertyAccessExpression:()=>ba,PropertyPrototype:()=>xi,Range:()=>ae,RefAsOp:()=>Py,RegexpLiteralExpression:()=>xa,Relooper:()=>pl,ReportMode:()=>Sl,Resolver:()=>Nn,ReturnStatement:()=>Ya,Runtime:()=>zs,RuntimeFeatures:()=>Ic,SETTER_PREFIX:()=>Vs,SIMDExtractOp:()=>bp,SIMDLoadOp:()=>Ep,SIMDLoadStoreLaneOp:()=>vp,SIMDReplaceOp:()=>xp,SIMDShiftOp:()=>Tp,SIMDTernaryOp:()=>Sp,STATIC_DELIMITER:()=>ln,STUB_DELIMITER:()=>Zu,SideEffects:()=>Bp,Signature:()=>De,Source:()=>fe,SourceKind:()=>ci,State:()=>ol,Statement:()=>oe,StringAsOp:()=>zy,StringEncodeOp:()=>My,StringEqOp:()=>Gy,StringIterMoveOp:()=>Uy,StringLiteralExpression:()=>Ea,StringMeasureOp:()=>Ly,StringNewOp:()=>Ny,StringSliceWTFOp:()=>Dy,SuperExpression:()=>va,SwitchBuilder:()=>En,SwitchCase:()=>Qa,SwitchStatement:()=>Ja,TSDBuilder:()=>Bi,Target:()=>Qr,TemplateLiteralExpression:()=>Sa,TernaryExpression:()=>Ta,ThisExpression:()=>Ia,ThrowStatement:()=>el,Token:()=>fi,Tokenizer:()=>bn,TrueExpression:()=>Fa,TryStatement:()=>tl,Type:()=>u,TypeBuilderErrorReason:()=>dp,TypeDeclaration:()=>il,TypeDefinition:()=>Xe,TypeFlags:()=>pt,TypeKind:()=>Wt,TypeName:()=>li,TypeNode:()=>fn,TypeParameterNode:()=>ea,TypeRef:()=>N,TypedElement:()=>Ft,Typeinfo:()=>Jr,TypeinfoFlags:()=>Us,UnaryExpression:()=>hn,UnaryOp:()=>vn,UnaryPostfixExpression:()=>ka,UnaryPrefixExpression:()=>Aa,UncheckedBehavior:()=>Tl,VariableDeclaration:()=>nl,VariableLikeDeclarationStatement:()=>ui,VariableLikeElement:()=>Er,VariableStatement:()=>sl,VoidStatement:()=>al,WhileStatement:()=>ll,addGlobalAlias:()=>MI,allocPtrArray:()=>_e,buildJS:()=>L0,buildTSD:()=>N0,compile:()=>B0,createType:()=>Ke,defaultFeatures:()=>Ml,diagnosticCategoryToColor:()=>ky,diagnosticCategoryToString:()=>up,diagnosticCodeToString:()=>Os,ensureType:()=>Pn,expandType:()=>Ip,featureToString:()=>Yr,findDecorator:()=>Et,formatDiagnostic:()=>Ay,formatDiagnosticMessage:()=>Ay,getBinaryLeft:()=>He,getBinaryOp:()=>mi,getBinaryRight:()=>Be,getBinaryenModuleRef:()=>M0,getBlockChildAt:()=>An,getBlockChildCount:()=>kn,getBlockName:()=>Rn,getBreakCondition:()=>Z2,getBreakName:()=>X2,getCallOperandAt:()=>ze,getCallOperandCount:()=>ot,getCallTarget:()=>Cn,getConstValueF32:()=>ge,getConstValueF64:()=>be,getConstValueI32:()=>ee,getConstValueI64High:()=>Pe,getConstValueI64Low:()=>Ee,getConstValueV128:()=>Fp,getDefaultParameterName:()=>jy,getDependee:()=>C0,getDiagnosticCategory:()=>g0,getDiagnosticCode:()=>y0,getDiagnosticMessage:()=>b0,getDiagnosticRange:()=>x0,getDiagnosticRelatedRange:()=>T0,getDropValue:()=>Q2,getExpressionId:()=>Q,getExpressionType:()=>ne,getFunctionBody:()=>tx,getFunctionName:()=>Cp,getFunctionParams:()=>rx,getFunctionResults:()=>ix,getFunctionVars:()=>nx,getGlobalGetName:()=>In,getGlobalInit:()=>lx,getGlobalName:()=>sx,getGlobalType:()=>ax,getIfCondition:()=>yl,getIfFalse:()=>yi,getIfTrue:()=>wn,getLoadBytes:()=>Rp,getLoadOffset:()=>V2,getLoadPtr:()=>q2,getLocalGetIndex:()=>lt,getLocalSetIndex:()=>dl,getLocalSetValue:()=>xr,getLoopBody:()=>$2,getLoopName:()=>j2,getMemoryGrowDelta:()=>ex,getRangeEnd:()=>v0,getRangeSource:()=>S0,getRangeStart:()=>E0,getReturnValue:()=>J2,getSelectCondition:()=>Y2,getSelectElse:()=>wp,getSelectThen:()=>Ap,getSideEffects:()=>gi,getSource:()=>m0,getSourceNormalizedPath:()=>I0,getStoreBytes:()=>O2,getStoreOffset:()=>W2,getStorePtr:()=>K2,getStoreValue:()=>H2,getTagName:()=>ox,getTagParams:()=>ux,getTagResults:()=>px,getUnaryOp:()=>Fn,getUnaryValue:()=>ml,initializeProgram:()=>P0,isConstExpressionNaN:()=>hl,isConstNaN:()=>D2,isConstNegZero:()=>fl,isConstNonZero:()=>et,isConstZero:()=>Fe,isDeclaredElement:()=>qn,isError:()=>k0,isGlobalMutable:()=>Pp,isIllegalVariableIdentifier:()=>fp,isInfo:()=>F0,isLoadSigned:()=>kp,isLocalTee:()=>Sn,isNullableType:()=>Vy,isTypeOmitted:()=>Ie,isTypedElement:()=>El,isWarning:()=>R0,mangleInternalName:()=>Ne,mangleInternalPath:()=>gn,mustPreserveSideEffects:()=>gl,newOptions:()=>TI,newProgram:()=>h0,nextDiagnostic:()=>d0,nextFile:()=>w0,operatorTokenToString:()=>Te,optimize:()=>z0,parse:()=>A0,readString:()=>Ge,removeGlobalAlias:()=>GI,runtimeFunctions:()=>ki,runtimeGlobals:()=>Ai,setBasenameHint:()=>p0,setBindingsHint:()=>c0,setBundleVersion:()=>WI,setDebugInfo:()=>f0,setExportMemory:()=>II,setExportRuntime:()=>VI,setExportStart:()=>zI,setExportTable:()=>CI,setFeature:()=>o0,setImportMemory:()=>FI,setImportTable:()=>wI,setInitialMemory:()=>RI,setLowMemoryLimit:()=>DI,setMaximumMemory:()=>kI,setMemoryBase:()=>NI,setNoAssert:()=>SI,setNoUnsafe:()=>UI,setOptimizeLevelHints:()=>u0,setPedantic:()=>_0,setRuntime:()=>vI,setSharedMemory:()=>AI,setSourceMap:()=>PI,setStackSize:()=>OI,setTableBase:()=>LI,setTarget:()=>EI,setUncheckedBehavior:()=>BI,tokenFromKeyword:()=>wy,tokenIsAlsoIdentifier:()=>Cy,typesToRefs:()=>vr,typesToString:()=>vl,util:()=>op,validate:()=>G0});var Z=typeof window<"u"&&window||typeof global<"u"&&global||self;if(typeof Z.ASC_TARGET>"u"){let e=function(){Error.captureStackTrace?Error.captureStackTrace(this,e):this.stack=this.name+": "+this.message+`
...
`),n.push(Ry(l,o))):(n.push(`
 in `),n.push(p.normalizedPath)),n.push("("),n.push(p.lineAt(l.start).toString()),n.push(","),n.push(p.columnAt().toString()),n.push(")")}}return Ys(r),n.join("")}function Ry(t,i=0){let e=t.source,r=e.text,n=r.length,s=t.start,a=s,l=e.lineAt(s).toString(),o=i?max(i.toString().length,l.length):l.length,p=" ".repeat(o);for(;s>0&&!bt(r.charCodeAt(s-1));)s--;for(;s<n&&on(r.charCodeAt(s));)s++;for(;a<n&&!bt(r.charCodeAt(a));)a++;let c=[p,`  :
...
`);for(let f=0,d=o.length;f<d;++f){let g=o[f];if(!Dr(g,1)){let S=n.getParameterName(f);U(a,this.indentLevel),a.push(S),a.push(" = "),this.makeLiftFromValue(S,g,a),a.push(`;
...
`);let o=a.length;for(let S=Map_keys(r),x=0,v=S.length;x<v;++x){let F=S[x],I=this.ensureModuleId(F),R=r.get(F);if(U(a,this.indentLevel),Me(F)?a.push(F):(a.push('"'),a.push(ye(F,34)),a.push('"')),!xI(F)){a.push(": __module"),a.push(I.toString()),a.push(`,
`);continue}let P=a.length;a.push(": Object.assign(Object.create("),F=="env"?a.push("globalThis"):(a.push("__module"),a.push(I.toString())),a.push("), "),F=="env"&&a.push("imports.env || {}, "),a.push(`{
`),++this.indentLevel;let B=0;for(let V=Map_keys(R),K=0,D=V.length;K<D;++K){let O=V[K],$=assert(R.get(O));if($.kind==5){let te=$,Y=this.getExternalCode(te);(!kc(te.signature,0)||!Me(O)||Y)&&(this.makeFunctionImport(F,O,$,Y),++B)}else if($.kind==0){let te=$;(!Dr(te.type,0)||!Me(O))&&(this.makeGlobalImport(F,O,te),++B)}}--this.indentLevel,B?(U(a,this.indentLevel),a.push(`}),
`)):(a.length=P,F=="env"?a.push(": Object.assign(Object.create(globalThis), imports.env || {})"):(a.push(": __module"),a.push(I.toString())),a.push(`,
`))}--this.indentLevel;let p=a.length>o;p?(U(a,this.indentLevel),a.push(`};
`)):a.length=o-2;let c=this.importMappings,_=new Array;for(let S=Map_keys(c),x=0,v=S.length;x<v;++x){let F=S[x];if(F=="env")_.push(`  const env = imports.env;
...
`)}if(this.needsLiftString){let S=n.OBJECTInstance,x=S.offsetof("rtSize")-S.nextMemoryOffset,v=1024;a.push(`  function __liftString(pointer) {
    if (!pointer) return null;
    const
...
`)}if(this.needsLowerArray){let S=n.arrayBufferInstance.id,x=n.arrayBufferViewInstance,v=x.nextMemoryOffset+4,F=x.offsetof("buffer"),I=x.offsetof("dataStart"),R=x.offsetof("byteLength"),P=R+4;this.needsSetU32=!0,a.push(`  function __lowerArray(lowerElement, id, align, values) {
    ...
    __dataview.setUint32(header + ${P}, length, true);
    for (let i = 0; i < length; ++i) lowerElement(buffer + (i << align >>> 0), values[i]);
    exports.__unpin(buffer);
    exports.__unpin(header);
    return header;
  }
`)}if(this.needsLiftTypedArray){let S=n.arrayBufferViewInstance,x=S.offsetof("dataStart"),v=S.offsetof("byteLength");this.needsGetU32=!0,a.push(`  function __liftTypedArray(constructor, pointer) {
    if (!pointer) return null;
...
`)}if(this.needsLowerTypedArray){let S=n.arrayBufferInstance.id,x=n.arrayBufferViewInstance,v=x.nextMemoryOffset,F=x.offsetof("buffer"),I=x.offsetof("dataStart"),R=x.offsetof("byteLength");this.needsSetU32=!0,a.push(`  function __lowerTypedArray(constructor, id, align, values) {
    if (values == null) return 0;
    const
      length = values.length,
      buffer = exports.__pin(exports.__new(length << align, ${S})) >>> 0,
...
`),this.program.options.exportRuntime){for(let v=0,F=ki.length;v<F;++v)a.push("  "),a.push(ki[v]),a.push(`,
`);for(let v=0,F=Ai.length;v<F;++v)a.push("  "),a.push(Ai[v]),a.push(`,
...
`);let S=!1,x=new Array;for(let v=Map_keys(c),F=0,I=v.length;F<I;++F){let R=v[F];if(R=="env")U(a,2),a.push(`env: globalThis,
`);else{let P=this.ensureModuleId(R);U(a,2),Me(R)?a.push(R):(a.push('"'),a.push(ye(R,34)),a.push('"')),a.push(": __maybeDefault(__import"),a.push(P.toString()),a.push(`),
`),x.push("import * as __import"),x.push(P.toString()),x.push(' from "'),x.push(ye(bI(R),34)),x.push(`";
...
`)}else e.push(`
`);U(e,this.indentLevel)}serializeParameter(i){let e=this.sb,r=i.parameterKind,n=i.implicitFieldDeclaration;n&&this.serializeAccessModifiers(n),r==2&&e.push("..."),this.visitIdentifierExpression(i.name);let s=i.type,a=i.initializer;s&&(r==1&&!a&&e.push("?"),Ie(s)||(e.push(": "),this.visitTypeNode(s))),a&&(e.push(" = "),this.visitNode(a))}serializeExternalModifiers(i){let e=this.sb;i.is(2)?e.push("export "):i.is(1)?e.push("import "):i.is(4)&&e.push("declare ")}serializeAccessModifiers(i){let e=this.sb;i.is(4)&&e.push("declare "),i.is(256)?e.push("public "):i.is(512)?e.push("private "):i.is(1024)&&e.push("protected "),i.is(32)?e.push("static "):i.is(128)&&e.push("abstract "),i.is(64)&&e.push("readonly ")}finish(){let i=this.sb.join("");return this.sb=[],i}};var rK=wc;export{Ac as ASTBuilder,mr as ArrayLiteralExpression,_i as ArrowKind,ia as AssertionExpression,pi as AssertionKind,gp as AtomicRMWOp,na as BinaryExpression,cl as BinaryModule,di as BinaryOp,Pa as BlockStatement,By as BrOnOp,Ba as BreakStatement,sa as CallExpression,Kt as Class,dn as ClassDeclaration,aa as ClassExpression,Kn as ClassPrototype,la as CommaExpression,pp as CommentKind,ra as CommentNode,Ve as CommonFlags,C as CommonNames,wa as CompiledExpression,hs as Compiler,Lp as ConditionKind,Up as ConstantValueKind,Sc as Constraints,oa as ConstructorExpression,Na as ContinueStatement,qI as DEFAULT_STACK_SIZE,We as DeclarationStatement,Ht as DeclaredElement,jt as DecoratorFlags,Tt as DecoratorKind,ta as DecoratorNode,Js as DiagnosticCategory,st as DiagnosticCode,qe as DiagnosticEmitter,Qs as DiagnosticMessage,La as DoStatement,Vn as Element,ua as ElementAccessExpression,ut as ElementKind,Ma as EmptyStatement,kl as Enum,Ga as EnumDeclaration,Al as EnumValue,za as EnumValueDeclaration,qa as ExportDefaultStatement,Ua as ExportImportStatement,Da as ExportMember,_s as ExportNames,Va as ExportStatement,de as Expression,br as ExpressionId,_l as ExpressionRunnerFlags,Oa as ExpressionStatement,yp as ExternalKind,a0 as FEATURES_ALL,l0 as FEATURES_DEFAULT,$I as FEATURE_BULK_MEMORY,YI as FEATURE_EXCEPTION_HANDLING,n0 as FEATURE_EXTENDED_CONST,t0 as FEATURE_GC,r0 as FEATURE_MEMORY64,e0 as FEATURE_MULTI_VALUE,HI as FEATURE_MUTABLE_GLOBALS,jI as FEATURE_NONTRAPPING_F2I,JI as FEATURE_REFERENCE_TYPES,i0 as FEATURE_RELAXED_SIMD,KI as FEATURE_SIGN_EXTENSION,XI as FEATURE_SIMD,s0 as FEATURE_STRINGREF,QI as FEATURE_TAIL_CALLS,ZI as FEATURE_THREADS,Ra as FalseExpression,Ut as Feature,mp as FeatureFlags,Wa as FieldDeclaration,Np as FieldFlags,On as File,pa as FloatLiteralExpression,St as Flow,xl as FlowFlags,Ha as ForOfStatement,Ka as ForStatement,ct as Function,mn as FunctionDeclaration,ca as FunctionExpression,je as FunctionPrototype,dr as FunctionTypeNode,Ds as GETTER_PREFIX,Tr as Global,ue as HeapTypeRef,Le as INDEX_SUFFIX,Xu as INNER_DELIMITER,$u as INSTANCE_DELIMITER,Oe as IdentifierExpression,_p as IdentifierHandling,ja as IfStatement,$a as ImportDeclaration,Pi as ImportNames,yn as ImportStatement,Mn as IndexSignature,Ca as IndexSignatureNode,_a as InstanceOfExpression,fa as IntegerLiteralExpression,Gn as Interface,Xa as InterfaceDeclaration,wl as InterfacePrototype,Ri as JSBuilder,nt as LIBRARY_PREFIX,qs as LIBRARY_SUBST,at as LiteralExpression,Vt as LiteralKind,Ue as Local,Bn as LocalFlags,hi as MemorySegment,yr as MethodDeclaration,Ot as Module,rl as ModuleDeclaration,hr as NamedTypeNode,Wn as Namespace,Za as NamespaceDeclaration,ha as NewExpression,L as Node,xt as NodeKind,da as NullExpression,ma as ObjectLiteralExpression,ya as OmittedExpression,Re as OperatorKind,fs as Options,d2 as PARENT_SUBST,Ye as PATH_DELIMITER,Tn as PackedType,zp as Parameter,gr as ParameterKind,oi as ParameterNode,ga as ParenthesizedExpression,Un as Parser,Oy as Precedence,Dn as Program,Ln as Property,ba as PropertyAccessExpression,xi as PropertyPrototype,ae as Range,Py as RefAsOp,xa as RegexpLiteralExpression,pl as Relooper,Sl as ReportMode,Nn as Resolver,Ya as ReturnStatement,zs as Runtime,Ic as RuntimeFeatures,Vs as SETTER_PREFIX,bp as SIMDExtractOp,Ep as SIMDLoadOp,vp as SIMDLoadStoreLaneOp,xp as SIMDReplaceOp,Tp as SIMDShiftOp,Sp as SIMDTernaryOp,ln as STATIC_DELIMITER,Zu as STUB_DELIMITER,Bp as SideEffects,De as Signature,fe as Source,ci as SourceKind,ol as State,oe as Statement,zy as StringAsOp,My as StringEncodeOp,Gy as StringEqOp,Uy as StringIterMoveOp,Ea as StringLiteralExpression,Ly as StringMeasureOp,Ny as StringNewOp,Dy as StringSliceWTFOp,va as SuperExpression,En as SwitchBuilder,Qa as SwitchCase,Ja as SwitchStatement,Bi as TSDBuilder,Qr as Target,Sa as TemplateLiteralExpression,Ta as TernaryExpression,Ia as ThisExpression,el as ThrowStatement,fi as Token,bn as Tokenizer,Fa as TrueExpression,tl as TryStatement,u as Type,dp as TypeBuilderErrorReason,il as TypeDeclaration,Xe as TypeDefinition,pt as TypeFlags,Wt as TypeKind,li as TypeName,fn as TypeNode,ea as TypeParameterNode,N as TypeRef,Ft as TypedElement,Jr as Typeinfo,Us as TypeinfoFlags,hn as UnaryExpression,vn as UnaryOp,ka as UnaryPostfixExpression,Aa as UnaryPrefixExpression,Tl as UncheckedBehavior,nl as VariableDeclaration,ui as VariableLikeDeclarationStatement,Er as VariableLikeElement,sl as VariableStatement,al as VoidStatement,ll as WhileStatement,MI as addGlobalAlias,_e as allocPtrArray,L0 as buildJS,N0 as buildTSD,B0 as compile,Ke as createType,rK as default,Ml as defaultFeatures,ky as diagnosticCategoryToColor,up as diagnosticCategoryToString,Os as diagnosticCodeToString,Pn as ensureType,Ip as expandType,Yr as featureToString,Et as findDecorator,Ay as formatDiagnostic,Ay as formatDiagnosticMessage,He as getBinaryLeft,mi as getBinaryOp,Be as getBinaryRight,M0 as getBinaryenModuleRef,An as getBlockChildAt,kn as getBlockChildCount,Rn as getBlockName,Z2 as getBreakCondition,X2 as getBreakName,ze as getCallOperandAt,ot as getCallOperandCount,Cn as getCallTarget,ge as getConstValueF32,be as getConstValueF64,ee as getConstValueI32,Pe as getConstValueI64High,Ee as getConstValueI64Low,Fp as getConstValueV128,jy as getDefaultParameterName,C0 as getDependee,g0 as getDiagnosticCategory,y0 as getDiagnosticCode,b0 as getDiagnosticMessage,x0 as getDiagnosticRange,T0 as getDiagnosticRelatedRange,Q2 as getDropValue,Q as getExpressionId,ne as getExpressionType,tx as getFunctionBody,Cp as getFunctionName,rx as getFunctionParams,ix as getFunctionResults,nx as getFunctionVars,In as getGlobalGetName,lx as getGlobalInit,sx as getGlobalName,ax as getGlobalType,yl as getIfCondition,yi as getIfFalse,wn as getIfTrue,Rp as getLoadBytes,V2 as getLoadOffset,q2 as getLoadPtr,lt as getLocalGetIndex,dl as getLocalSetIndex,xr as getLocalSetValue,$2 as getLoopBody,j2 as getLoopName,ex as getMemoryGrowDelta,v0 as getRangeEnd,S0 as getRangeSource,E0 as getRangeStart,J2 as getReturnValue,Y2 as getSelectCondition,wp as getSelectElse,Ap as getSelectThen,gi as getSideEffects,m0 as getSource,I0 as getSourceNormalizedPath,O2 as getStoreBytes,W2 as getStoreOffset,K2 as getStorePtr,H2 as getStoreValue,ox as getTagName,ux as getTagParams,px as getTagResults,Fn as getUnaryOp,ml as getUnaryValue,P0 as initializeProgram,hl as isConstExpressionNaN,D2 as isConstNaN,fl as isConstNegZero,et as isConstNonZero,Fe as isConstZero,qn as isDeclaredElement,k0 as isError,Pp as isGlobalMutable,fp as isIllegalVariableIdentifier,F0 as isInfo,kp as isLoadSigned,Sn as isLocalTee,Vy as isNullableType,Ie as isTypeOmitted,El as isTypedElement,R0 as isWarning,Ne as mangleInternalName,gn as mangleInternalPath,gl as mustPreserveSideEffects,TI as newOptions,h0 as newProgram,d0 as nextDiagnostic,w0 as nextFile,Te as operatorTokenToString,z0 as optimize,A0 as parse,Ge as readString,GI as removeGlobalAlias,ki as runtimeFunctions,Ai as runtimeGlobals,p0 as setBasenameHint,c0 as setBindingsHint,WI as setBundleVersion,f0 as setDebugInfo,II as setExportMemory,VI as setExportRuntime,zI as setExportStart,CI as setExportTable,o0 as setFeature,FI as setImportMemory,wI as setImportTable,RI as setInitialMemory,DI as setLowMemoryLimit,kI as setMaximumMemory,NI as setMemoryBase,SI as setNoAssert,UI as setNoUnsafe,u0 as setOptimizeLevelHints,_0 as setPedantic,vI as setRuntime,AI as setSharedMemory,PI as setSourceMap,OI as setStackSize,LI as setTableBase,EI as setTarget,BI as setUncheckedBehavior,wy as tokenFromKeyword,Cy as tokenIsAlsoIdentifier,vr as typesToRefs,vl as typesToString,op as util,G0 as validate};
