// Test using hardcoded data
import { readFileSync } from 'fs';
import { instantiate } from '@assemblyscript/loader';

// Hardcoded data from events_rows.csv
...
async function test() {
  try {
    ...
    console.log(`Data contains ${HARDCODED_DATA.length} records`);

    // Create a mock FDW
    const mockFdw = new MockFdw(HARDCODED_DATA);
    ...
    console.log('\nTesting FDW functions with hardcoded data...');
